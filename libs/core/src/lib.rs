...
pub use domain::{
    ...
    Equipment, EquipmentId, FileObject, Invitation, InvitationId, Invoice, InvoiceId, InvoiceKind,
    InvoiceLine, InvoiceLineId, InvoiceStatus, InvoiceVatBreakdownLine, LegalIdentity, Member,
    MemberId, MemberProfitability, MemberWithAccount, MemberWorkTime, MinuteInterval, MissingCost,
