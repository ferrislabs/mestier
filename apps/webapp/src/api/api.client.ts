export namespace Schemas {
	...
	export type AuthSchemeResponse = {
	...
	export type AvailabilityResponse = {
		resources: Array<AvailabilityResourceResponse>
	}
	export type BranchDto = 'Then' | 'Else' | 'Each' | 'After'
	export type BulkAssignTasksRequest = {
		assignees: Array<AssigneeRefRequest>
	...
	export type Component =
		...
		| {
				accessory?: (null | Component) | undefined
				children: Array<Component>
				type: 'SECTION'
		  }
		...
		| {
				divider: boolean
				spacing?: (null | SeparatorSpacing) | undefined
				type: 'SEPARATOR'
		  }
	...
	export type CreateInvitationRequest = Partial<{
		expires_at: string | null
		member_id: null | MemberId
	}>
	...
	export type CreateMessageRequest = {
		attachments?: Array<CreateMessageAttachment> | undefined
		content: string
	}
	...
	export type CredentialWithSecretResponse = CredentialResponse & {
		secret: unknown
	}
	...
	export type GraphInvalidBody = {
		code: string
		details: GraphInvalidDetails
		message: string
		status: number
	}
	...
	export type MinuteIntervalResponse = {
		ends_minute: number
	...
	export type PlanningWorkTimeDayResponse = {
		date: string
		intervals: Array<MinuteIntervalResponse>
	}
	export type PlanningWorkTimeResponse = {
		days: Array<PlanningWorkTimeDayResponse>
		member_id: MemberId
	}
...
export namespace Endpoints {
	...
	export type get_GetWorkTime = {
		...
		responses: {
			200: {
				data: {
					rhythms: Array<Schemas.RhythmResponse>
					work_slots: Array<Schemas.WorkSlotResponse>
				}
				pagination?: (null | Schemas.PaginationMetadata) | undefined
			}
			400: unknown
	...
	export type put_SaveWorkflowVersion = {
		...
		responses: {
			...
			422: {
				code: string
				details: Schemas.GraphInvalidDetails
				message: string
				status: number
			}
		}
	...
	export type patch_PatchTask = {
		...
		responses: {
			200: {
				data: { task: Schemas.TaskResponse }
				pagination?: (null | Schemas.PaginationMetadata) | undefined
			}
			400: unknown
			401: unknown
