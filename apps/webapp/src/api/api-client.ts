...
export namespace Endpoints {
	...
	export type get_ListEmployees = {
		...
		responses: {
			200: {
				data: Array<Schemas.EmployeeResponse>
				pagination?: (null | Schemas.PaginationMetadata) | undefined
			}
			401: unknown
			403: unknown
	...
	export type get_ListEquipment = {
		...
		responses: {
			200: {
				data: Array<Schemas.EquipmentResponse>
				pagination?: (null | Schemas.PaginationMetadata) | undefined
			}
			401: unknown
			403: unknown
	...
	export type post_CreateEquipment = {
		...
		responses: {
			201: {
				data: Schemas.EquipmentResponse
				pagination?: (null | Schemas.PaginationMetadata) | undefined
			}
			400: unknown
			401: unknown
	...
	export type get_ListServiceRates = {
		...
		responses: {
			200: {
				data: Array<Schemas.ServiceRateResponse>
				pagination?: (null | Schemas.PaginationMetadata) | undefined
			}
			401: unknown
			403: unknown
	...
	export type post_CreateServiceRate = {
		...
		responses: {
			201: {
				data: Schemas.ServiceRateResponse
				pagination?: (null | Schemas.PaginationMetadata) | undefined
			}
			400: unknown
			401: unknown
