...
#[openapi(
    ...
    paths(
        ...
        planning::work_order::bulk_create::handler,
    ...
    components(schemas(
        ...
        planning::work_order::bulk_create::BulkCreateWorkOrdersRequest,
        planning::work_order::bulk_create::BulkCreateWorkOrderItemRequest,
        planning::work_order::bulk_create::BulkCreateWorkOrdersResponse,
        ...
        planning::planning::get_planning::PlanningResourceKindResponse,
